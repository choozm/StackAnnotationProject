...
/**
 * <p>
 * A <strong>MyStringStack</strong>
 * </p>
 * is a class that implements a simple (LIFO) stack object. It makes use of the
 * Vector {@link java.util.Vector}
 * <p>
 * It has four basic operations: <code>push()</code> to push an element onto the
 * stack <code>pop()</code> to retrieve the last pushed element
